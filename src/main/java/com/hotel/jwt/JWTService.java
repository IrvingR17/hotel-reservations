...
public class JWTService {
    ...
    public Boolean validateToken(String theToken, HotelUserDetails userDetails){
        final String userName = extractUsernameFromToken(theToken);
        return ((userName.equals(userDetails.getUsername()) || userName.equals(userDetails.getEmail())) && !isTokenExpired(theToken));
    }
